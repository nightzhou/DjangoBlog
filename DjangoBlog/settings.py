...
# ALLOWED_HOSTS = []
ALLOWED_HOSTS = ['*', '127.0.0.1', 'danhuazhou.cn']
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('BLOGDBNAME'),  # 数据库名字(需要先创建)
        'USER': os.environ.get('BLOGDBUSER'),  # 登录用户名
        'PASSWORD': os.environ.get('BLOGDBPASSWORD'),  # 密码
        'HOST': os.environ.get('BLOGDBHOST'),  # 数据库IP地址,留空默认为localhost
        'PORT': os.environ.get('BLOGDBPORT'),  # 端口
    }
}
